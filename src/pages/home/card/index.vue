      ...
      <div class="left">
        ...
        <div class="tip">
          <div class="level">
            ...
            <span>{{
              hospitalCarData.hostype == "1"
                ? "三级甲等"
                : hospitalCarData.hostype == "2"
                ? "二级乙等"
                : hospitalCarData.hostype == "3"
                ? "一级丁等"
                : "未知等级"
            }}</span>
          </div>
...
//接受父亲传递过来的数据
const props = defineProps(["hospitalCarData"]);
//进行路由跳转到详情页面
...
const goDetail = () => {
  ...
  $router.push({
    ...
    query: { hoscode: props.hospitalCarData.hoscode },
  });
};
</script>
